...
sos_bell_i10 <- filter_paths(graph = g, from = soses, to = belloc, weight='weight', filter = max_accidents*0.10, paths = sos_bell_paths)
jun_men_i10  <- filter_paths(graph = g, from = juneda, to = menarguens, weight='weight', filter = max_accidents*0.10, paths = jun_men_paths)
...
sos_bell_i25 <- filter_paths(graph = g, from = soses, to = belloc, weight='weight', filter = max_accidents*0.25, paths = sos_bell_paths)
jun_men_i25  <- filter_paths(graph = g, from = juneda, to = menarguens, weight='weight', filter = max_accidents*0.25, paths = jun_men_paths)
...
sos_bell_i50 <- filter_paths(graph = g, from = soses, to = belloc, weight='weight', filter = max_accidents*0.50, paths = sos_bell_paths)
jun_men_i50  <- filter_paths(graph = g, from = juneda, to = menarguens, weight='weight', filter = max_accidents*0.50, paths = jun_men_paths)
...
sos_bell_i75 <- filter_paths(graph = g, from = soses, to = belloc, weight='weight', filter = max_accidents*0.75, paths = sos_bell_paths)
jun_men_i75  <- filter_paths(graph = g, from = juneda, to = menarguens, weight='weight', filter = max_accidents*0.75, paths = jun_men_paths)
